...
export function SponsorGrid({ lang }: SponsorGridProps) {
  ...
  const content = {
    ar: {
      title: "اختر ما تريد رعايته",
      subtitle: "كل عنصر يمثل حاجة حقيقية في رحلة إبراهيم",
      available: "متاح",
      of: "من",
      claimed: "محجوز",
      sponsor: "ارعَ هذا",
      sponsorMultiple: "ارعَ",
      units: "وحدات",
      total: "المجموع",
      currency: "€",
      categories: {
      ...
      impactMessage: "تبرعك سيظهر باسمك على لوحة الشرف",
      proceedToDonate: "تابع للتبرع",
    },
    en: {
      title: "Choose What to Sponsor",
      subtitle: "Each item represents a real need in Ibrahim's journey",
      available: "available",
      of: "of",
      claimed: "claimed",
      sponsor: "Sponsor This",
      sponsorMultiple: "Sponsor",
      units: "units",
      total: "Total",
      currency: "€",
      categories: {
      ...
      impactMessage: "Your contribution will appear with your name on the Honor Board",
